...
class ZBotBERcon
{
  ...
  chatMessagesAction(message) {
    ...
    switch (true) {
      case (message.startsWith('(Side)')):
        ...
        embedMessage.setColor(this._cfg.embedColors.side);
      ...
      case (message.startsWith('(Group)')):
        ...
        embedMessage.setColor(this._cfg.embedColors.group);
      ...
      case (message.startsWith('(Direct)')):
        ...
        embedMessage.setColor(this._cfg.embedColors.direct);
      ...
      case (message.startsWith('(Vehicle)')):
        ...
        embedMessage.setColor(this._cfg.embedColors.vehicle);
      ...
      case (message.startsWith('(Global)')):
        ...
        if (message.includes('ᐅ'))   {
          ...
          embedMessage.setColor(this._cfg.embedColors.global);
      ...
      case (message.startsWith('RCon admin') ):
        if (message.includes('(To'))   {
          ...
          embedMessage.setColor(this._cfg.embedColors.privateadmin);
          ...
          if (message.includes('logged in')) {
            ...
            isChat = false;
            embedMessage.setColor(this._cfg.embedColors.admin);
            this.dissectMessage(embedMessage, 'rcon','', message);
      ...
      case (message.startsWith('Player #') || message.startsWith('Verified GUID') ):
        ...
        embedMessage.setColor(this._cfg.embedColors.joins);
    ...
    if(!disableShow) {
      if (channel) {
        if (this._cfg.sendMessagesAsEmbeds ) {
  ...
  hasCorrectRole(message, command) {
    ...
    if(role) {
      let answer = message.member.roles.cache.find((r) => r.name === role);
      if(!answer) {
    ...
    if (message.channelId === this.channels.command.id) {
      ...
      switch (true)
      {
        case (content.includes('teststeam ')):
          ...
          //   break;
          // }
          this.cmdSteamTestPrintData(content.toString().replace("teststeam ", ""));
          break;
